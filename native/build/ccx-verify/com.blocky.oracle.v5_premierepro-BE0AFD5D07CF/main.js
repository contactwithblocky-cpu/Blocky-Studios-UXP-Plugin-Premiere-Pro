...
class OracleDedicatedPanelMount {
  ...
  start() {
    ...
    if (this.uiRuntime && typeof this.uiRuntime.capture === "function") {
      this.uiRuntime.capture(this.root, "workspace-ready");
    }
    return this;
  }
...
async function initializeOraclePanel(bootstrapState = null) {
  ...
  try {
    ...
    if (readyUiRuntime && typeof readyUiRuntime.capture === "function" && readyRoot) {
      readyUiRuntime.capture(readyRoot, "controller-ready");
    }
    if (typeof recordOracleDiagnostic === "function") {

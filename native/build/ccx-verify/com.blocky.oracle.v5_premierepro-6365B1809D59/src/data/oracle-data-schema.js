...
function validateOracleState(state) {
  ...
  if (state.schema !== ORACLE_STATE_SCHEMA) errors.push("Unsupported Blocky Studios state schema");
  if (state.version !== ORACLE_STATE_VERSION) errors.push("Unsupported Blocky Studios state version");

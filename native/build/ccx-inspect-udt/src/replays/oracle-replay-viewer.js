...
(function exposeOracleReplayViewer(globalScope, factory) {
  ...
  class ReplayViewerController {
    ...
    sync() {
      ...
      if (this.elements.root.dataset) this.elements.root.dataset.viewerState = state.phase;
    ...
    reportError(error, fallbackMessage, options = {}) {
      ...
      this.stopPolling();
      if (ownershipLost) this.ownershipToken = "";
    ...
    async openReplay(replay) {
      ...
      return this.enqueue(async () => {
        ...
        if (previousToken) {
          try {
            ...
            if (generation === this.generation) {
              return this.reportError(error, "Premiere could not release the previous Source Monitor replay.", { openFailure: true });
            }
            return false;
          }
        ...
        try {
          ...
          return this.reportError(error, "Premiere could not open this replay in Source Monitor.", { openFailure: true });
        }

...
(function exposeOraclePremiereCurvesAdapter(globalScope, factory) {
  ...
  const REASON_MESSAGES = Object.freeze({
    ...
    [REASON.UNPROVEN_TIME_BASIS]: "Curves Apply is currently verified only for an untrimmed, zero-start, forward 1x clip. This clip's keyframe time basis remains gated for the Milestone 9 matrix.",
